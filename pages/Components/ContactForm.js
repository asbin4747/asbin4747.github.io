...
export default function ContactForm() {
  ...
  const form = useRef();
  const serviceId = process.env.NEXT_PUBLIC_SERVICE_ID.replaceAll("\"","");
  const templateId = process.env.NEXT_PUBLIC_TEMPLATE_ID.replaceAll("\"","");
  const publicKey = process.env.NEXT_PUBLIC_PUBLIC_KEY.replaceAll("\"","");
